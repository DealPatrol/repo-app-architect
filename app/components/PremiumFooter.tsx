...
const links = {
  Product: [
    { label: "Repo Analysis", href: "#" },
    { label: "Discover Projects", href: "#" },
    { label: "Find Files", href: "#" },
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2">
            <span className="text-xl font-bold gradient-text">Repo Architect</span>
            <p className="text-sm text-[var(--text-muted)] mt-3 max-w-xs">
              AI-powered GitHub intelligence for teams who ship.
            </p>
          </div>
          {Object.entries(links).map(([group, items]) => (
            <div key={group}>
              <h4 className="text-sm font-semibold text-[var(--text)] mb-4">{group}</h4>
        ...
        <div className="mt-12 pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-[var(--text-subtle)] hover:text-[var(--accent)] transition-colors">
